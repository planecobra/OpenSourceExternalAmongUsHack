        ...
        public static void Initialize(string name, string aid, string secret, string version)
        {
            ...
            using (WebClient wc = new WebClient())
            {
                ...
                try
                {
                    ...
                    {
                        MessageBox.Show("Security error has been triggered!", Name);
                    ...
                    switch (response[2])
                    {
                        case "success":
                            ...
                            {
                                MessageBox.Show("Application is in Developer Mode, bypassing integrity and update check!", Name);
                                ...
                                MessageBox.Show("Your applications hash has been saved to integrity.txt, please refer to this when your application is ready for release!", Name);
                            ...
                            else
                            {
                                if (response[12] == "Enabled")
                                {
                                    ...
                                    {
                                        MessageBox.Show($"File has been tampered with, couldn't verify integrity!", Name);
                                ...
                                {
                                    MessageBox.Show($"Update {ApplicationSettings.Version} available, redirecting to update!", Name);
                            ...
                            {
                                MessageBox.Show("Looks like this application is disabled, please try again later!", Name);
                        ...
                        case "binderror":
                            ...
                            return;
                        case "banned":
                            MessageBox.Show("This application has been banned for violating the TOS" + Environment.NewLine + "Contact us at support@auth.gg", Name);
